create table derived.perplot_seedling as
SELECT
...
alter table derived.perplot_seedling add column polt_geom geometry(Point,4269);
update derived.perplot_seedling A set polt_geom = B.geom
