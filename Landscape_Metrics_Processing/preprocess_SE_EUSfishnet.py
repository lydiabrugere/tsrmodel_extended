...
geom_sql = """select distinct grid_id as grid_id, wkb_geometry as grid_geom from variable_eus.trekwetmetrics_projected"""
...
for index in range(geom.shape[0]):
    ...
    cropped_raster = "../data/fishneteus/clipped2grid/grid" + str(grid_id) + '.tif'
